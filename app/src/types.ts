export interface TelegramFile {
    ...
    mime_type?: string;
    file_ext?: string;
    /** An active link generated by this app exists for this file. */
...
export interface TelegramFolder {
    ...
    is_shared?: boolean;
    /** True when this Telegram account owns the folder/channel. */
    is_owned?: boolean;
    /** Folder belongs to another Telegram account but is accessible here. */
...
export interface FolderParticipantInfo {
    user_id: number;
    first_name: string;
    last_name?: string;
    username?: string;
